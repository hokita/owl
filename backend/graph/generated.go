...
type ComplexityRoot struct {
	...
	Query struct {
		MonthReview func(childComplexity int, year int, month int) int
...
type QueryResolver interface {
	...
	MonthReview(ctx context.Context, year int, month int) (*model.Review, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.monthReview":
		if e.complexity.Query.MonthReview == nil {
			break
		}

		args, err := ec.field_Query_monthReview_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Query.MonthReview(childComplexity, args["year"].(int), args["month"].(int)), true
...
func (ec *executionContext) field_Query_monthReview_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	arg0, err := ec.field_Query_monthReview_argsYear(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["year"] = arg0
	arg1, err := ec.field_Query_monthReview_argsMonth(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["month"] = arg1
...
func (ec *executionContext) field_Query_monthReview_argsYear(
	ctx context.Context,
	rawArgs map[string]interface{},
) (int, error) {
...
func (ec *executionContext) field_Query_monthReview_argsMonth(
	ctx context.Context,
	rawArgs map[string]interface{},
) (int, error) {
...
func (ec *executionContext) _Query_monthReview(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Query_monthReview(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().MonthReview(rctx, fc.Args["year"].(int), fc.Args["month"].(int))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) fieldContext_Query_monthReview(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Query",
		Field:      field,
		IsMethod:   true,
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Query_monthReview_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
...
func (ec *executionContext) unmarshalInputCreateReviewInput(ctx context.Context, obj interface{}) (model.CreateReviewInput, error) {
	...
	fieldsInOrder := [...]string{"year", "month", "notes"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
	...
	for i, field := range fields {
		...
		case "monthReview":
			...
			innerFunc := func(ctx context.Context, _ *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Query_monthReview(ctx, field)
				return res
			}
