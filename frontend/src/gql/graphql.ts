...
export type CreateReviewMutation = { __typename?: 'Mutation', createReview: { __typename?: 'Review', id: string, year: number, month: number, week: number, created_at: string, updated_at: string } };
